...
const fondo4=document.getElementById('cuartanoticia');
    ...
    var ruta="url(imagenes/"+ noticias[valorinicio-1].imagen+".jpg)";
    ...
    var ruta="url(imagenes/"+ noticias[valorinicio-2].imagen+".jpg)";
  ...
  mypp3.textContent = "";
    ...
    var ruta="url(imagenes/"+ noticias[valorinicio-3].imagen+".jpg)";
